...
const translations = {
    en: {
        ...
        // User management
        viewManageUsers: 'View and manage all platform users',
        userList: 'User List',
    ...
    ar: {
        ...
        // User management
        viewManageUsers: 'عرض وإدارة جميع مستخدمي المنصة',
...
function setLanguage(lang) {
    ...
    // Trigger re-render of dynamic content if function exists
...
function formatNumber(num) {
    const lang = getCurrentLanguage();
    return lang === 'ar' ? toArabicNumerals(num) : String(num);
}
