...
const translations = {
    en: {
        ...
        browseSubjects: 'Browse and study your enrolled subjects',
        availableQuizzes: 'Available Quizzes',
        testKnowledge: 'Test your knowledge and track your progress',
        completed: 'Completed',
        averageScore: 'Average Score',
        myAssignments: 'My Assignments',
        viewSubmitAssignments: 'View and submit your assignments',
        pending: 'Pending',
        submitted: 'Submitted',
        graded: 'Graded',
        allAssignments: 'All Assignments',
        bookTutoringSession: 'Book Tutoring Session',
        scheduleOneOnOne: 'Schedule one-on-one sessions with teachers',
        yourScheduledSessions: 'Your Scheduled Sessions',
        noScheduledSessions: 'No scheduled sessions. Book a session with a teacher below.',
        availableTeachers: 'Available Teachers',
        bookSessionBtn: 'Book Session',
        messagesTitle: 'Messages',
        chatWithTeachers: 'Chat with your teachers',
        teachers: 'Teachers',
    ...
    ar: {
        ...
        // Student pages
        mySubjects: 'موادي',
        browseSubjects: 'تصفح ودرس موادك المسجلة',
        availableQuizzes: 'الاختبارات المتاحة',
        testKnowledge: 'اختبر معرفتك وتتبع تقدمك',
        completed: 'مكتمل',
        averageScore: 'متوسط الدرجات',
        myAssignments: 'واجباتي',
        viewSubmitAssignments: 'عرض وتقديم واجباتك',
        pending: 'معلق',
        submitted: 'مقدم',
        graded: 'مقيم',
        allAssignments: 'جميع الواجبات',
        bookTutoringSession: 'حجز جلسة تدريس',
        scheduleOneOnOne: 'جدولة جلسات فردية مع المعلمين',
        yourScheduledSessions: 'جلساتك المجدولة',
        noScheduledSessions: 'لا توجد جلسات مجدولة. احجز جلسة مع معلم أدناه.',
        availableTeachers: 'المعلمون المتاحون',
        bookSessionBtn: 'احجز جلسة',
        messagesTitle: 'الرسائل',
        chatWithTeachers: 'تحدث مع معلميك',
        teachers: 'المعلمون',
        selectTeacher: 'اختر معلمًا',
        myProgress: 'تقدمي',
        trackLearningJourney: 'تتبع رحلة تعلمك',
        quizzesCompleted: 'الاختبارات المكتملة',
        subjectsStudied: 'المواد المدروسة',
        timeSpentLabel: 'الوقت المستغرق',
        recentQuizResults: 'نتائج الاختبارات الأخيرة'
    }
};
